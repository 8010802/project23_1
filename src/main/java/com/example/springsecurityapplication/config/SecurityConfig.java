...
//                .antMatchers("/user").hasAnyRole("USER")
                ...
                .antMatchers("/auth/login", "/error", "/auth/registration", "/product", "/product/info/{id}", "/product/search", "/index", "/warranty", "/img/**", "/images/**", "/styles/**", "/user/userPage", "/product/contacts", "/contacts", "/static").permitAll()
